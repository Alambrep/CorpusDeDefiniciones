...
def seleccionar_archivo_pdf():
    ...
    if ruta_archivo_pdf:
        convertir_pdf_a_texto(ruta_archivo_pdf)
        # Cerrar la ventana emergente después de seleccionar el archivo
        root.destroy()
...
boton_seleccionar_pdf = tk.Button(root, text="Seleccionar archivo PDF", command=seleccionar_archivo_pdf)
