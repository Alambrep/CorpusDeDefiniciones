...
def obtener_palabra_usuario():
    ...
    return input("Ingrese una palabra para agregar al listado de palabras a omitir (o 'salir' para terminar): ")
...
def main():
    # Función principal del programa: Generar o actualizar una lista de palabras a omitir.
    archivo = 'Listados/listado_palabras_a_omitir.txt'
