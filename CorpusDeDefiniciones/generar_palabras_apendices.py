...
def obtener_palabra_usuario():
    ...
    return input("Ingrese una palabra para agregar al listado de apendices (o 'salir' para terminar): ")
...
def main():
    # Función principal del programa: Generar o actualizar una lista de apendices.
    archivo = 'Listados/listado_apendices.txt'
