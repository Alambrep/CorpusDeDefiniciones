...
def obtener_palabra_usuario():
    ...
    return input("Ingrese una palabra para agregar al listado de palabras que se descartan en el corpus (o 'salir' para terminar): ")
...
def main():
    # Función principal del programa: Generar o actualizar una lista de palabras que se descartan en el corpus.
    archivo = 'Listados/listado_descartes_corpus.txt'
